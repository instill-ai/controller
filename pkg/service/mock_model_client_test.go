...
// WatchModelInstance mocks base method.
func (m *MockModelPublicServiceClient) WatchModelInstance(arg0 context.Context, arg1 *modelv1alpha.WatchModelInstanceRequest, arg2 ...grpc.CallOption) (*modelv1alpha.WatchModelInstanceResponse, error) {
	m.ctrl.T.Helper()
	varargs := []interface{}{arg0, arg1}
	for _, a := range arg2 {
		varargs = append(varargs, a)
	}
	ret := m.ctrl.Call(m, "WatchModelInstance", varargs...)
	ret0, _ := ret[0].(*modelv1alpha.WatchModelInstanceResponse)
	ret1, _ := ret[1].(error)
	return ret0, ret1
}

// WatchModelInstance indicates an expected call of WatchModelInstance.
func (mr *MockModelPublicServiceClientMockRecorder) WatchModelInstance(arg0, arg1 interface{}, arg2 ...interface{}) *gomock.Call {
	mr.mock.ctrl.T.Helper()
	varargs := append([]interface{}{arg0, arg1}, arg2...)
	return mr.mock.ctrl.RecordCallWithMethodType(mr.mock, "WatchModelInstance", reflect.TypeOf((*MockModelPublicServiceClient)(nil).WatchModelInstance), varargs...)
}
